...
//    private float worldTimer = 180;
    ...
    public GameScreen(MazeGame game) {
        ...
        timer = new Timer();
        timeLeft = Integer.toString((int)timer.currentTime());
...
//        System.out.println(player.position.getX() + " , " + co.nearestItem(player).getPosition().getX());
		...
		font.draw(game.batch, timeLeft, 500,500);
...
//			timeLeft = Integer.toString((int) worldTimer);
//    		timer = 0;
//		}
//	}

	private void displayText(SpriteBatch batch, String text, int x, int y) {
