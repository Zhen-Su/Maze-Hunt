...
/**
 * When the player connects to serve, send the current position, ID and other
 * information to the server through udp.
 * 
 * @author kevin
 *
 */
public class NewMessage implements Message {
	...
	public NewMessage(Player player) {
		this.player = player;
		this.gameClient = gameClient;
	}

	public NewMessage(GameClient gameClient) {
	...
	public void process(DataInputStream dis) {
		 try{
	            ...
	            if(!exist) {
	                NewMessage msg = new NewMessage(gameClient);
